...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "repositories",
          description: "Some cool things I worked on.",
          section: "Navigation",
          handler: () => {
      ...
      handler: () => {
          ...
          title: 'Parrying God',
          description: "Designer and Developer  Sekiro meets Smash Bros.  January 2025 - May 2025",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6A%61%79%64%65%6E%63%68%61%6E%32%36@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/JaydenChanAK", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/jaydenchanak", "_blank");
        },
      },{
      id: 'light-theme',
